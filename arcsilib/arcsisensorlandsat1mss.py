...
class ARCSILandsat1MSSSensor (ARCSIAbstractSensor):
    ...
    def extractHeaderParameters(self, inputHeader, wktStr):
        ...
        try:
            ...
            # Get the sensor info.
            if ((headerParams["SPACECRAFT_ID"].upper() == "LANDSAT_1") or (headerParams["SPACECRAFT_ID"].upper() == "LANDSAT1")) and (headerParams["SENSOR_ID"].upper() == "MSS"):
                self.sensor = "LS1MSS"
            else:
            ...
            self.b4MinRad = arcsiUtils.str2Float(headerParams["RADIANCE_MINIMUM_BAND_4"], 0.000)
            self.b4MaxRad = arcsiUtils.str2Float(headerParams["RADIANCE_MAXIMUM_BAND_4"], 201.000)
            self.b5MinRad = arcsiUtils.str2Float(headerParams["RADIANCE_MINIMUM_BAND_5"], 9.100)
            self.b5MaxRad = arcsiUtils.str2Float(headerParams["RADIANCE_MAXIMUM_BAND_5"], 171.300)
            self.b6MinRad = arcsiUtils.str2Float(headerParams["RADIANCE_MINIMUM_BAND_6"], -8.400)
            self.b6MaxRad = arcsiUtils.str2Float(headerParams["RADIANCE_MAXIMUM_BAND_6"], 161.600)
            self.b7MinRad = arcsiUtils.str2Float(headerParams["RADIANCE_MINIMUM_BAND_7"], 0.000)
            self.b7MaxRad = arcsiUtils.str2Float(headerParams["RADIANCE_MAXIMUM_BAND_7"], 159.000)
    ...
    def setBandNames(self, imageFile):
        """
        Set band names for Landsat 1 MSS
